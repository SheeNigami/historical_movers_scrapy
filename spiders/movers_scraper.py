...
class MoversSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for movers in response.css('table#tblForDesktop > tr:nth-child(1) > td'):
            ...
            to_return['movers'][move] = to_append
    ...
    def parse_cdx(self, response, target_time, finviz_url):
        try:
        ...
        yield scrapy.Request(url=snapshot_url, dont_filter=False, callback=self.parse_finviz)
